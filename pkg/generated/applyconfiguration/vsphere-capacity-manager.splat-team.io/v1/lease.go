...
import (
	data "github.com/openshift-splat-team/vsphere-capacity-manager/data"
...
type LeaseApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *data.LeaseSpec `json:"spec,omitempty"`
...
func Lease(name, namespace string) *LeaseApplyConfiguration {
	...
	b.WithKind("Lease")
	b.WithAPIVersion("vsphere-capacity-manager.splat-team.io/v1")
	return b
}
...
func (b *LeaseApplyConfiguration) WithSpec(value data.LeaseSpec) *LeaseApplyConfiguration {
	b.Spec = &value
	return b
}
...
func (b *LeaseApplyConfiguration) WithStatus(value data.LeaseSpec) *LeaseApplyConfiguration {
	b.Status = &value
	return b
}
