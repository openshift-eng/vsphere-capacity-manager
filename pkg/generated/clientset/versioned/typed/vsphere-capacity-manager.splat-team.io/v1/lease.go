...
import (
	...
	scheme "github.com/openshift-splat-team/vsphere-capacity-manager/pkg/generated/clientset/versioned/scheme"
...
Apply(ctx context.Context, lease *vspherecapacitymanagersplatteamiov1.LeaseApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Lease, err error)
	LeaseExpansion
}
...
func newLeases(c *Vsphere-capacity-managerV1Client, namespace string) *leases {
	return &leases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *leases) Apply(ctx context.Context, lease *vspherecapacitymanagersplatteamiov1.LeaseApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Lease, err error) {
	if lease == nil {
