...
LDFLAGS="${LDFLAGS} -X github.com/openshift-eng/vsphere-capacity-manager/pkg/version.Raw=${GIT_TAG} -X github.com/openshift-eng/vsphere-capacity-manager/pkg/version.Commit=${GIT_COMMIT}"
TAGS="${TAGS:-}"
